...
def get_rs2_score(seq, model_file):
    ...
    try:
        ...
        raise Exception(
            "could not find model stored to file %s. Perhaps the scikit-learn package is of another version." % model_file)
    if seq[25:27] == 'GG':
...
if __name__ == '__main__':
    ...
    model_file_1 = resource_filename(__name__, 'V3_model_nopos.pickle')
    model_file_2 = resource_filename(__name__, 'V3_model_full.pickle')
